<template>
  <div style="padding: 10px">
    ...
    <el-table :data="tableData" border stripe style="width: 100%">
      ...
      <el-table-column prop="name" label="招聘单位"> </el-table-column>
      <el-table-column prop="job" label="招聘职位"> </el-table-column>
      <el-table-column prop="content" label="招聘详情"> </el-table-column>
      <el-table-column prop="time" label="招聘时间"></el-table-column>
